...
import * as apidomNsOpenApi30 from '@speclynx/apidom-ns-openapi-3-0';
import * as apidomNsOpenApi31 from '@speclynx/apidom-ns-openapi-3-1';
...
async function validate(document, cliOptions) {
    ...
    const createToolbox = () => ({
        deps: {
            ...
            '@speclynx/apidom-ns-openapi-3-0': apidomNsOpenApi30,
            '@speclynx/apidom-ns-openapi-3-1': apidomNsOpenApi31,
