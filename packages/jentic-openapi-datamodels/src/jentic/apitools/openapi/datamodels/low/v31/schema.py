...
NestedSchema: TypeAlias = "Schema | ValueSource[YAMLInvalidValue]"
        ...
        # properties (dict[KeySource[str], NestedSchema])
            ...
            if isinstance(value_node, yaml.MappingNode):
                ...
                for prop_key_node, prop_value_node in value_node.value:
                    ...
                    prop_schema: NestedSchema = build(prop_value_node, context)
                    properties_dict[KeySource(value=prop_key, key_node=prop_key_node)] = prop_schema
                field_values[field_name] = FieldSource(
