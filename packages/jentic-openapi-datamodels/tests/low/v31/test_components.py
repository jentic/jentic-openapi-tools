...
def test_build_with_path_items(parse_yaml):
...
def test_build_with_mixed_components_including_path_items(parse_yaml):
...
def test_build_with_path_items_empty_object(parse_yaml):
...
def test_build_with_path_items_preserves_order(parse_yaml):
...
def test_build_with_path_items_invalid_type(parse_yaml):
